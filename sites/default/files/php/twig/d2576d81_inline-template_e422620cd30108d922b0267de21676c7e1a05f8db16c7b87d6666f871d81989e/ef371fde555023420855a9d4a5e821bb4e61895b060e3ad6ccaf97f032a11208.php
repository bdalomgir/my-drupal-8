...
/* {# inline_template_start #}<article class="row node-article path-news">
...
class __TwigTemplate_d40a43611fb78efb015284f18b2ab0b482d97ef1ae90cca9345cfe51deda5fe2 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 1
        echo "<article class=\"row node-article path-news\">
...
\t</div>
    ...
    {
        return "{# inline_template_start #}<article class=\"row node-article path-news\">
\t<div class=\"col news-image\">{{ field_image }}{{ field_post_image }}</div>
\t<div class=\"col news-info\">
\t\t<div class=\"row title\"><h3>{{ title }}</h3></div>
\t\t<div class=\"row meta\">{{ created }}</div>
