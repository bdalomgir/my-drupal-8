...
jQuery(document).ready(function ($) {    
    ...
    $('#block-views-block-clery-def-accordian-new-block-1 .views-row span a').click(function (e) {
        e.preventDefault();
    });
    $('#block-views-block-clery-def-accordian-new-block-1 .views-row div.a-legand').click(function () {
